    ...
    return (
        ...
        >
            <div className=' border-2 border-x-gray-100 border-y-black p-3 border-y-2'>
                ...
                <div className='mt-4'>
                    <AnimatedNewsColumn data={data.data.news?.sports?.data ?? []} className='lg:h-[500px] p-2 w-full' />
                </div>
            </div>
            <div className='mt-8  border-2 border-x-gray-100 p-3  border-y-black  border-y-2'>
                ...
                <div className='mt-4'>
                    <AnimatedNewsColumn data={data.data.news?.life_style?.data ?? []} className='lg:h-[410px] p-2' />
                </div>
            </div>
        </div>
    )
